...
-- Global Variables
-------------------------------------------------
local g_ReligiousBeliefsManager = GenerationalInstanceManager:new("YourReligiousBeliefInstance", "Base", Controls.YourReligiousBeliefsStack);
local g_FaithModifierManager = GenerationalInstanceManager:new("FaithModifierInstance", "FaithModifier", Controls.FaithModifierStack);
local g_WorldReligionsManager = GenerationalInstanceManager:new( "WorldReligionInstance", "Base", Controls.WorldReligionsStack);
local g_BeliefsManager = GenerationalInstanceManager:new( "BeliefInstance", "Base", Controls.BeliefsStack);
