...
function NQMP_Autocracy_T3_Jingoism_OnAdoptPolicy(iPlayer)

	local pPlayer = Players[iPlayer];
	local pPromotion = GameInfoTypes.PROMOTION_JINGOISM;
...
GameEvents.PlayerAdoptPolicy.Add(NQMP_Autocracy_T3_Jingoism_OnAdoptPolicy);